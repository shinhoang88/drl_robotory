...
class RealRobotorydownscaleEnv(gym.Env):
    ...
    def step(self, action, stepnum):
        ...
        for i in range(self.numJoints):
            self.next_joint_pos[i] = self.prev_joint_pos[i] + 0.001*action[i]

        msg = seven_py()
        msg.a = self.next_joint_pos[0]
        msg.b = self.next_joint_pos[1]
        msg.c = self.next_joint_pos[2]
